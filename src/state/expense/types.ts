...
import type { DeleteExpensePayload, ExpenseAddPayload, ExpenseFilterPayload } from "../../services/expenseService.ts";
...
export interface GetFilteredExpenseAction {
    type: typeof GET_FILTER_EXPENSE;
    payload: ExpenseFilterPayload;
}

export interface AddExpenseAction {
    type: typeof ADD_EXPENSE;
    payload: ExpenseAddPayload;
}
